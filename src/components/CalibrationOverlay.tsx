            ...
            isLandscape ? (
                <View className="flex-row items-center gap-12">
                     ...
                     <View className="gap-2">
                        <Text className="text-white text-4xl font-bold">{i18n.t('calibrated')}</Text>
                        <Text className="text-white/60 text-lg mb-8">
                            {i18n.t('calibrationSaved')}
                        </Text>
                         <TouchableOpacity 
                            onPress={onCancel}
                            className="bg-white/10 px-8 py-3 rounded-full self-start"
                        >
            ...
            isLandscape ? (
                <View className="flex-row items-center gap-16">
                    ...
                    <View className="items-center justify-center">
                         <View className="w-48 h-48 rounded-full border-4 border-accent-copper items-center justify-center bg-white/5 shadow-2xl shadow-accent-copper/20">
                    ...
                    <View className="gap-6 max-w-sm">
                        ...
                        <View className="h-16 justify-center">
                             {timeLeft > 2 ? (
                                <Text key="start-msg" className="text-white text-3xl font-bold text-left">{i18n.t('startMachine')}</Text>
                            ) : timeLeft > 0 ? (
                                <Text key="measuring-msg" className="text-white/70 text-2xl text-left animate-pulse">{i18n.t('measuring')}</Text>
                            ) : (
